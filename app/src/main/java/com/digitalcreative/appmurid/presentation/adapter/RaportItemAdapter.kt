...
class RaportItemAdapter : RecyclerView.Adapter<RaportItemAdapter.ViewHolder>() {
    var raportItems = listOf<Raport.Detail.Item>()
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(raportItem: Raport.Detail.Item) {
            with(itemView) {
                tv_raport_text.text = raportItem.detail
                tv_raport_value.text = raportItem.answer.answer
            }
        }
    }
}